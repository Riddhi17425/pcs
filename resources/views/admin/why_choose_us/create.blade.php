                                    ...
                                    <div class="card-body row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="whychooseus_title"
                                                ...
                                                value="{{ old('whychooseus_title') }}" placeholder="Enter Title Here">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="file" name="whychooseus_image" id="whychooseus_image"
                                                ...
                                                <span class="text-danger" id="span_whychoose_image"></span>
                                            @error('whychooseus_image')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <div class="preview_whychoose_image-zone mt-2 d-flex flex-wrap gap-2 position-relative">
                                            </div>
                                             <img id="preview_whychooseuse_image" src="#" alt="Preview" class="mt-2" style="max-width: 100%; height: auto; display: none;" />
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="whychooseus_status"
                                                ...
                                                <option value="Active"
                                                    {{ old('whychooseus_status') == 'Active' ? 'selected' : '' }}>Active
                                                </option>
                                                <option value="In-Active"
                                                    {{ old('whychooseus_status') == 'In-Active' ? 'selected' : '' }}>Inactive
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="whychooseus_alt"
                                                ...
                                                value="{{ old('whychooseus_alt') }}" placeholder="Enter Alt Here">
                                        ...
                                        <div class="card mb-4 border">
                                            <div class="card mb-4 border">
                                                ...
                                                <div class="card-body">
                                                    <textarea name="whychooseus_desc" class="form-control @error('whychooseus_desc') is-invalid @enderror" rows="4"
                                                        id="whychooseus_desc">{{ old('whychooseus_desc') }}</textarea>
