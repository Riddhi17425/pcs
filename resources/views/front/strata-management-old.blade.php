...
<section class="com_hero" style="background-image: url(' {{ asset('public/front/images/data-security-hero-bg.jpg') }}');">
    <div class="container">
        <div class="com_hero_child">
            <h1>Strata Management Outsourcing</h1>
            <p class="col-lg-7 m-auto">PCS Global is a trusted strata management company providing end-to-end solutions for strata property management, compliance, and maintenance. Our professional strata team ensures every property is well-managed, cost-efficient.</p>
...
<section class="trust mt-100 ">
    <div class="container">
        ...
        <div class="trust_scroll_wrapper">
                      <div class="trust_banner trust_banner_strata" style="background-image: url('{{asset('public/front/images/strata-management_7.png')}}');">
                ...
                <div class="trust_card tax_preparation">
                    ...
                    <p class="audit_comp_para" style="font-weight:400; margin-bottom:16px">We manage all types of residential strata, from boutique apartments to large complexes. Our services ensure efficient levy collection, proactive maintenance, and transparent reporting. We focus on protecting property value while promoting harmonious community living.</p>
                      ...
                      <a class="btn-trust-banner" data-bs-toggle="offcanvas" data-bs-target="#residential" aria-controls="residential" >
                               <i class="fa-solid fa-minus"></i> <span class="text-padding">Read More</span>
                            </a>
                            
                </div>
            </div>
            <div class="trust_banner trust_banner_strata" style="background-image: url('{{asset('public/front/images/strata-management_10.png')}}');">
                <!--<img class="img-fluid" src="{{ asset('public/front/images/strata-management_7.png') }}" alt="bg1" />-->
                <div class="trust_card tax_preparation">
                    <div class="trust_card_head">
                    ...
                    <p class="audit_comp_para" style="font-weight:400; margin-bottom:16px"> We manage office towers, retail precincts, and industrial facilities with tailored expertise. Our services focus on maximizing revenue, controlling costs, and ensuring compliance. We help protect asset value while supporting efficient and sustainable operations.</p>
                     ...
                     <a class="btn-trust-banner" data-bs-toggle="offcanvas" data-bs-target="#commercial" aria-controls="commercial" >
                               <i class="fa-solid fa-minus"></i> <span class="text-padding">Read More</span>
                            </a>
            ...
            <div class="trust_banner trust_banner_strata" style="background-image: url('{{asset('public/front/images/strata-management_10.png')}}');">
                ...
                <div class="trust_card tax_preparation">
                    ...
                    <p class="audit_comp_para" style="font-weight:400; margin-bottom:16px">We manage developments combining residential, retail, and commercial spaces under one framework. Our services coordinate shared budgets, utilities, and common areas for seamless operations. We balance the needs of diverse owner groups to ensure every part of the community thrives.</p>
                     <!--read more button for offcanvas-->
                     <a class="btn-trust-banner" data-bs-toggle="offcanvas" data-bs-target="#mixed" aria-controls="mixed" >
                               <i class="fa-solid fa-minus"></i> <span class="text-padding">Read More</span>
                            </a>
        ...
        <div class="row gy-4 gy-lg-0 gx-lg-5 align-items-center">
            ...
            <div class="col-lg-7 ">
                <div>
                    ...
                    <p class="my-4">Lorem ipsum dolor sit amet consectetur. Non nunc volutpat egestas placerat eleifend. Et hendrerit pellentesque aliquam id massa purus. Vel non nisl augue interdum sit in. Porta feugiat neque vitae aliquet volutpat pulvinar integer vitae. Id etiam a tortor tristique. Amet purus arcu etiam id facilisi. Aliquam nisi pellentesque facilisis sed facilisis neque nibh id vitae. Vitae at mi eu ut quam at nunc lobortis fusce. Risus at consectetur arcu aliquet </p>
                    <div class="row">
                         <div class="col-md-5">
                             <ul>
                                <li>
...
<section class="mt-100">
    <div class="container">
        ...
        <div class="com_sec_head_top mb-4">
            <h2 class="mb-2 mb-xxl-4">Maintenance & Communication</h2>
...
<section class="mt-80">
 ...
 <!--read more content for offcanvas-->
<section class="mt-100">
    <div class="container">
        <div class="com_inner_banners my-4 my-lg-3">
            <div class="row align-items-lg-end align-items-xxl-center">
                <div class="col-lg-6">
                    <div class="com_inner_banner">
                        <h2>Tailored Solutions. Clear Pricing.
                            Request Your Quote in Minutes</h2>
                        <a class="com_btn1 color-animated-button bubble-btn" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            data-hover-colors='["#B074BC","#CF7C7C","#7496BC","#7B9993","#9F7159","#EAD1DC","#D7BDE2","#D7BDE2","#FFD1BA","#D1F2EB","#A4C8F0","#F7A1A1","#A0E6E0","#F9B7B7","#E6FFB3","#FFF4B3","#FFE4B5","#FFD4B8","#FFCBA4","#FFB399"]'>
...
{	
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, PCS Global can manage both residential and commercial strata properties. Our expert team specializes in strata administration, operations, and property management, offering tailored solutions to meet the unique needs of residential communities and commercial complexes."
    }
  }]
}
</script>
